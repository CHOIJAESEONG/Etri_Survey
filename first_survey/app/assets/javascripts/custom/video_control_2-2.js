				...
				success: function(data){
					...
					console.log(data);
						if(data!=undefined){
							...
							console.log("111asdf");
							var i=0;
							for (i in data[0].media_url_list){
								data[0].media_url_list[i]='/assets/'+data[0].media_url_list[i];
							}
							video_link=data[0].media_url_list;

							i=0;
							for (i in data[0].thumb_list){
								data[0].thumb_list[i]='/assets/'+data[0].thumb_list[i];
							}
							thumbList=data[0].thumb_list;
